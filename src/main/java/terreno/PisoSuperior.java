...
public class PisoSuperior {
	...
	public PisoSuperior(Stage stage, Group root,Jugador pj){
		this.pj = pj;
	...
	public void crearConfiguracion(Stage stage, Group root) {
		...
		var vistaConsumibles = new VistaTiendaDeConsumibles(stage,root, pj,consumibles);
		
		var vistaVentas = new VistaEstacionDeVenta(stage, root, pj);
